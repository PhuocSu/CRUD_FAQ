...
const ActionButtons = ({ onSubmit, onTemporarySave, onCancel, onLoading }) => {
  return (
    <div style={{ display: 'flex', gap: '16px' }}>
      <Button
        ...
        <div
          style={{ color: 'var(--button-primary-fg, white)', fontSize: 14, fontFamily: 'Noto Sans KR', fontWeight: '700', lineHeight: 20, wordWrap: 'break-word' }}>확인</div>
      </Button>
